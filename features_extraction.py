...
def google_index(url):
    site=search(url, tld="co.in", num=1, stop=1, pause=2)
    if site:
        return 1
    else:
        return -1
...
def main(url):
    # url = sys.argv[1]
    with open('markup.txt', 'r') as file:  ##you may have to mention the whole address of markup.txt from "/home/username/.."##
